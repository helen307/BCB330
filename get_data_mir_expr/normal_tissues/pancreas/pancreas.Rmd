...
```{r setup}
knitr::opts_knit$set(root.dir = normalizePath("/Users/helending/Documents/BCB330/code/normal_tissues/pancreas")) 
```
# Library
```{r}
library(knitr)
...
URL <- "https://www.ebi.ac.uk/arrayexpress/files/E-GEOD-43796"
SDRF.file <- "E-GEOD-43796.sdrf.txt"
Data.file <- "E-GEOD-43796.raw.1.zip"
...
norm_ind <- which(SDRF$`Comment [Sample_source_name]` == "non-neoplastic pancreas")
```
...
save_known_and_novel(unique_all_table=unique_all, tissue_name="pancreas")
```