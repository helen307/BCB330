...
---
```{r setup}
knitr::opts_knit$set(root.dir = normalizePath("/Users/helending/Documents/BCB330/code/normal_tissues/mammary_gland"))
```
# Library
```{r}
library(knitr)
...
URL <- "https://www.ebi.ac.uk/arrayexpress/files/E-GEOD-45666"
SDRF.file <- "E-GEOD-45666.sdrf.txt"
Data.file <- "E-GEOD-45666.raw.1.zip"
...
# View(SDRF)
all_sample <- SDRF[,c("Array Data File","Characteristics [tissue type]")]
norm_ind <- which(SDRF$`Characteristics [tissue type]` == "Adjacent Normal")
```
# Read data
```{r}
...
save_known_and_novel(unique_all_table=unique_all, tissue_name="mammary.gland")
```
