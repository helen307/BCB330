...
---
```{r setup}
knitr::opts_knit$set(root.dir = normalizePath("/Users/helending/Documents/BCB330/code/normal_tissues/salivary_gland")) 
```
# Library
```{r}
library(knitr)
...
URL <- "https://www.ebi.ac.uk/arrayexpress/files/E-GEOD-41268"
SDRF.file <- "E-GEOD-41268.sdrf.txt"
Data.file <- "E-GEOD-41268.raw.1.zip"
...
norm_ind <- which(SDRF$`Characteristics [disease state]` == "healthy")
```
...
save_known_and_novel(unique_all_table=unique_all, tissue_name="salivary.gland")
```