...
---
```{r setup}
    knitr::opts_knit$set(root.dir = normalizePath("/Users/helending/Documents/BCB330/code/normal_tissues/kidney")) 
```
# Library
```{r}
library(knitr)
...
norm_ind <- grep(pattern="GeneView", SDRF[norm_ind, "Array Data File"], inv=T)
```
...
save_known_and_novel(unique_all_table=unique_all, tissue_name="kidney")
```